...
impl AreaMapping {
    pub fn into_values(self) -> [Area; 34] {
        [
            self.a1, self.a2, self.a3, self.a4, self.a5, self.a6, self.a7, self.a8, self.b1,
            self.b2, self.b3, self.b4, self.b5, self.b6, self.b7, self.b8, self.e1, self.e2,
            self.e3, self.e4, self.e5, self.e6, self.e7, self.e8, self.d1, self.d2, self.d3,
            self.d4, self.d5, self.d6, self.d7, self.d8, self.c1, self.c2,
        ]
    }
}
...
impl Default for AreaMapping {
    fn default() -> Self {
        Self {
            ...
            e1: Area::new(
                E1_POS,
                vec![finale::B1, finale::B8],
                Duration::default(),
                Duration::default(),
            ),
            e2: Area::new(
                E2_POS,
                vec![finale::B1, finale::B2],
                Duration::default(),
                Duration::default(),
            ),
            e3: Area::new(
                E3_POS,
                vec![finale::B2, finale::B3],
                Duration::default(),
                Duration::default(),
            ),
            e4: Area::new(
                E4_POS,
                vec![finale::B3, finale::B4],
                Duration::default(),
                Duration::default(),
            ),
            e5: Area::new(
                E5_POS,
                vec![finale::B4, finale::B5],
                Duration::default(),
                Duration::default(),
            ),
            e6: Area::new(
                E6_POS,
                vec![finale::B5, finale::B6],
                Duration::default(),
                Duration::default(),
            ),
            e7: Area::new(
                E7_POS,
                vec![finale::B6, finale::B7],
                Duration::default(),
                Duration::default(),
            ),
            e8: Area::new(
                E8_POS,
                vec![finale::B7, finale::B8],
                Duration::default(),
                Duration::default(),
            ),
            ...
            d1: Area::new(
                D1_POS,
                vec![finale::A1, finale::A8],
                Duration::default(),
                Duration::default(),
            ),
            d2: Area::new(
                D2_POS,
                vec![finale::A1, finale::A2],
                Duration::default(),
                Duration::default(),
            ),
            d3: Area::new(
                D3_POS,
                vec![finale::A2, finale::A3],
                Duration::default(),
                Duration::default(),
            ),
            d4: Area::new(
                D4_POS,
                vec![finale::A3, finale::A4],
                Duration::default(),
                Duration::default(),
            ),
            d5: Area::new(
                D5_POS,
                vec![finale::A4, finale::A5],
                Duration::default(),
                Duration::default(),
            ),
            d6: Area::new(
                D6_POS,
                vec![finale::A5, finale::A6],
                Duration::default(),
                Duration::default(),
            ),
            d7: Area::new(
                D7_POS,
                vec![finale::A6, finale::A7],
                Duration::default(),
                Duration::default(),
            ),
            d8: Area::new(
                D8_POS,
                vec![finale::A7, finale::A8],
                Duration::default(),
                Duration::default(),
            ),
